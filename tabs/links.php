<?php
// links.php — Gestão de links web com SQLite, edição, filtro e exportação
session_start();
...
// Filtro
$filtro = $_GET['filtro'] ?? '';
$stmt = $db->prepare("SELECT * FROM links WHERE categoria LIKE :filtro ORDER BY criado_em DESC");
